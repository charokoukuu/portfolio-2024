...
export const internship: InternType[] = [
  ...
  },
  {
    ...
    content:
      'とある案件のECサイトの新機能開発。フロントエンドはNuxt.jsを使用。コンポーネントのメモ化などの描画負荷に配慮したフロントの実装やjestを用いた単体テストの実装を行いました。また、バックエンドではGoLand(Gin)を使用し、クリーンアーキテクチャに則ったAPIエンドポイントの実装を行いました。',
  },
  {
    name: 'Sky株式会社',
    term: '2024年3月〜現在(長期)',
