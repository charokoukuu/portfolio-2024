...
export const internship: InternType[] = [
  ...
  },
  {
    ...
    content:
      'マルチプレイヤーゲームのリアルタイム技術を学びました。TPS用の専用ゲームサーバーを設計・実装し、クライアントとサーバー間のリアルタイム通信のプロトコルを設計しました。コロプラのサーバーエンジン「prizm」を使い、リアルタイム同期やゲーム内イベントの処理を行い、さらにクラウド展開やチート対策など運用課題にも取り組みました。',
  },
  {
    name: 'LINEヤフー株式会社',
