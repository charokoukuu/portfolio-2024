...
export const ProfileCard = () => {
  return (
    <div>
      <Box className="relative h-[400px] w-[400px] rounded-2xl bg-[url('https://avatars.githubusercontent.com/u/35647163?v=4')]">
        <Box className="bg-custom-gradient absolute left-0 top-0 h-full w-full rounded-2xl" />
        <Text className="absolute left-[46px] top-[74px] text-6xl font-bold text-white">
          Hinata
          <br />
          Saito
        </Text>
        <Text className="absolute left-[49px] top-[200px] text-2xl font-bold text-white">
          2001/10/31
        </Text>
        <Box className="absolute bottom-7 left-1/2 mt-4 flex -translate-x-1/2 transform gap-10">
          <a
