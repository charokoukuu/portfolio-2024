    ...
    <div>
      <Box className=" h-[90vw] w-[90vw] rounded-2xl bg-gradient-to-b from-[#00BFCB] to-[#000] p-5 sm:h-[350px] sm:w-[350px]">
        ...
        <Text className="text-sm text-white">
          私は、フロントエンドを専門とするエンジニア大学院生です。PdMの経験があり、Next.js/Vue.jsを用いた開発が得意です。バックエンドでは、Node.jsフレームワークのExpressやNest.jsを使用し、MongoDBやPostgreSQLを扱っています。最近では、長期インターンにてgRPCやGraphQLを活用し、DIパターンベースのクリーンアーキテクチャを用いたマイクロサービスやBFFの開発に取り組んでいます。
